// =============================================================================
// SCRIPT: CCS_BusinessDeactivatedEventArgs
// CATEGORY: Modules / Settlements / Runtime / Businesses
// PURPOSE: Event payload when a settlement business deactivates after thresholds fall.
...
{
    public sealed class CCS_BusinessDeactivatedEventArgs
    {
