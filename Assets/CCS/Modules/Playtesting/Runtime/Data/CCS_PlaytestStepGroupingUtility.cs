    ...
    public static class CCS_PlaytestStepGroupingUtility
    {
        ...
        public static CCS_PlaytestStepGroup ResolveGroup(CCS_PlaytestStepType stepType)
        {
            switch (stepType)
            {
                ...
                case CCS_PlaytestStepType.DiscoverSettlementForPopulation:
                case CCS_PlaytestStepType.CompleteContractForPopulationGrowth:
                case CCS_PlaytestStepType.VerifyPopulationIncreased:
                case CCS_PlaytestStepType.VerifyPopulationNonNegative:
                case CCS_PlaytestStepType.VerifyPopulationGrowthRateValid:
                ...
                case CCS_PlaytestStepType.DiscoverSettlementForBusinessPresence:
                case CCS_PlaytestStepType.VerifyBusinessMarkersExist:
                case CCS_PlaytestStepType.TriggerBusinessActivationForMarkers:
                case CCS_PlaytestStepType.VerifyBusinessMarkerActive:
                case CCS_PlaytestStepType.SaveBusinessPresenceState:
                ...
                case CCS_PlaytestStepType.DiscoverSettlementForNpcSchedule:
                case CCS_PlaytestStepType.SpawnNamedNpcForSchedule:
                case CCS_PlaytestStepType.VerifyNpcScheduleAssigned:
                case CCS_PlaytestStepType.ForceEvaluateNpcScheduleWorkBlock:
                case CCS_PlaytestStepType.VerifyNpcScheduleWorkplaceTarget:
                case CCS_PlaytestStepType.ForceEvaluateNpcScheduleHomeBlock:
                case CCS_PlaytestStepType.VerifyNpcScheduleHousingTarget:
                case CCS_PlaytestStepType.SaveNpcScheduleState:
                ...
                case CCS_PlaytestStepType.DiscoverSettlementForNpcDialogue:
                case CCS_PlaytestStepType.SpawnNamedNpcForDialogue:
                case CCS_PlaytestStepType.InteractWithNpcForDialogue:
                case CCS_PlaytestStepType.VerifyNpcDialogueGreeting:
                case CCS_PlaytestStepType.VerifyNpcDialogueRoleIntroduction:
                case CCS_PlaytestStepType.VerifyNpcDialogueServiceHint:
                case CCS_PlaytestStepType.SaveNpcDialogueState:
