...
// AUTHOR: James Schilz
// CREATED: 2026-06-07
// NOTES: Toggle via CCS_NetcodeTestConstants.EnableControllerAuditLogs.
// =============================================================================
...
namespace CCS.Modules.CharacterController.Tests.Netcode
{
    public static class CCS_NetworkControllerAuditDiagnostics
    {
        ...
        public static bool IsEnabled => CCS_NetcodeTestConstants.EnableControllerAuditLogs;

        public static bool MotorMoveLogsEnabled => CCS_NetcodeTestConstants.EnableControllerAuditLogs
            && CCS_NetcodeTestConstants.EnableMotorMoveAuditLogs;

        public static bool InputLogsEnabled => CCS_NetcodeTestConstants.EnableControllerAuditLogs
            && CCS_NetcodeTestConstants.EnableInputAuditLogs;

        public static bool JumpLogsEnabled => CCS_NetcodeTestConstants.EnableControllerAuditLogs
            && (CCS_NetcodeTestConstants.EnableJumpAuditLogs
                || CCS_CharacterControllerConstants.EnableJumpDebugLogs);

        public static bool DisableNetworkTransformForAudit => CCS_NetcodeTestConstants.DisableNetworkTransformForAudit;
        ...
        public static void LogSceneComposition()
        {
            ...
            builder.AppendLine($"  OfflinePlayerActive: {DescribeActiveObject(CCS_NetcodeTestConstants.OfflineTestPlayerSceneName)}");
            builder.AppendLine($"  SceneCameraRigCount: {CountNamedRoots(CCS_NetcodeTestConstants.SceneCameraRigName)}");
