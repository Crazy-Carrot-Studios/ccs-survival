...
namespace CCS.Modules.CharacterController.Tests.Netcode
{
    public static class CCS_LocalMultiplayerPlayerNameCache
    {
        ...
        private static string pendingLocalDisplayName = CCS_NetcodeTestConstants.DefaultDisplayName;
        ...
        {
            pendingLocalDisplayName = CCS_NetcodeTestConstants.DefaultDisplayName;
        }
