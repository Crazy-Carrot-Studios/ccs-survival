...
namespace CCS.Modules.CharacterController.Tests.Netcode
{
    public static class CCS_MultiplayerPlayerNameUtility
    {
        ...
        public static string Sanitize(string rawName)
        {
            ...
            {
                return CCS_NetcodeTestConstants.DefaultDisplayName;
            }

            string trimmed = rawName.Trim();
            if (trimmed.Length > CCS_NetcodeTestConstants.MaxDisplayNameLength)
            {
                trimmed = trimmed.Substring(0, CCS_NetcodeTestConstants.MaxDisplayNameLength);
            }
