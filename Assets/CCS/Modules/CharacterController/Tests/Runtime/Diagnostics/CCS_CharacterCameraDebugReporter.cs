...
// PLACEMENT: Auto-added to CCS_TestingManager by CCS_CharacterControllerTestingManager.
// AUTHOR: James Schilz
// CREATED: 2026-06-25
...
namespace CCS.Modules.CharacterController.Tests
{
    ...
    public sealed class CCS_CharacterCameraDebugReporter : MonoBehaviour
    {
        ...
        private CCS_CharacterControllerTestingManager testingManager;
        ...
        private void Awake()
        {
            testingManager = GetComponent<CCS_CharacterControllerTestingManager>();
        }
