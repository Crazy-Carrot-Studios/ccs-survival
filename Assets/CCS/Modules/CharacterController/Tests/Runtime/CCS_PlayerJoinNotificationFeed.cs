...
// PLACEMENT: MasterTestUiCanvas/CCS_PlayerJoinNotificationFeed in SCN_CCS_CharacterController_MasterTest.
// AUTHOR: James Schilz
// CREATED: 2026-06-07
...
namespace CCS.Modules.CharacterController.Tests
{
    public sealed class CCS_PlayerJoinNotificationFeed : MonoBehaviour
    {
        ...
        [SerializeField] private int maxEntries = CCS_MasterTestUiConstants.JoinNotificationMaxEntries;
        ...
        {
            if (!CCS_MasterTestNetworkSessionUtility.IsNetworkSessionActive() || entriesContainer == null)
            {
                return;
            }

            string sanitizedName = string.IsNullOrWhiteSpace(playerName)
                ? CCS_MasterTestUiConstants.DefaultJoinPlayerDisplayName
                : playerName.Trim();
        ...
        private void ResolvePanelReference()
        {
            ...
            Transform panelTransform = transform.Find(CCS_MasterTestUiConstants.JoinNotificationPanelObjectName);
        ...
        {
            if (!CCS_MasterTestNetworkSessionUtility.IsNetworkSessionActive() || panelRoot == null)
            {
                return;
            }
        ...
        private void UpdatePanelVisibility()
        {
            ...
            bool showPanel = CCS_MasterTestNetworkSessionUtility.IsNetworkSessionActive()
        ...
        private TMP_Text CreateEntryText(string message)
        {
            ...
            text.text = message;
            text.fontSize = 16f;
            text.color = CCS_MasterTestUiConstants.JoinEntryTextColor;
