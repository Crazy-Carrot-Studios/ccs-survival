...
// =============================================================================
// SCRIPT: CCS_ValidationSpawnController
...
// PLACEMENT: CCS_ValidationSpawnController scene object in master test scene.
// AUTHOR: James Schilz
// CREATED: 2026-06-07
...
namespace CCS.Modules.CharacterController.Local {
    ...
    public sealed class CCS_ValidationSpawnController : MonoBehaviour
    {
        ...
        private void SpawnSoloPlayer()
        {
            ...
            CCS_LocalPlayerSessionConfigurator.TryConfigureOfflinePlayer(
                spawnedSoloPlayer,
                displayProfile,
                cameraController);
        ...
        private void ApplyDefaultBodyVisual(GameObject player)
        {
            ...
            Transform bodyVisual = player.transform.Find(CCS_PlayerPrefabConstants.CapsuleVisualName);
            if (bodyVisual == null)
            {
                return;
            }
        ...
        private IEnumerator RebindCameraAfterFrame(GameObject player)
        {
            ...
            CCS_LocalPlayerSessionConfigurator.BindSceneCamera(player, cameraController, displayProfile);
        }
