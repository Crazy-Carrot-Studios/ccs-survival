...
// =============================================================================
// SCRIPT: CCS_ValidationNpcRunner
// CATEGORY: Modules / CharacterController / Tests / Runtime
// PURPOSE: Drives the offline test NPC along master test traversal points.
// PLACEMENT: PF_CCS_CharacterController_ValidationNpc root.
// AUTHOR: James Schilz
// CREATED: 2026-06-07
// NOTES: Resolves route targets by CCS_ValidationControllerPoint ids when routePoints is empty.
// =============================================================================

namespace CCS.Modules.CharacterController.Validation {
    public sealed class CCS_ValidationNpcRunner : MonoBehaviour
    {
        ...
        private static Dictionary<string, Transform> BuildTestPointLookup()
        {
            ...
            CCS_ValidationControllerPoint[] testPoints = FindObjectsByType<CCS_ValidationControllerPoint>(
                FindObjectsInactive.Include, FindObjectsSortMode.None);

            for (int i = 0; i < testPoints.Length; i++)
            {
                CCS_ValidationControllerPoint testPoint = testPoints[i];
