...
namespace CCS.Modules.CharacterController.Netcode
{
    public static class CCS_NetworkPlayerJoinAnnouncer
    {
        ...
        private static void EnsureLifecycleSubscription()
        {
            ...
            {
                CCS_PlayerSessionEvents.PlayerSpawned += HandlePlayerSpawned;
                CCS_PlayerSessionEvents.PlayerNameChanged += HandlePlayerNameChanged;
                CCS_PlayerSessionEvents.JoinNotificationFeedReady += HandleJoinNotificationFeedReady;
        ...
        private static void HandlePlayerSpawned(CCS_PlayerSessionContext context)
        {
        ...
        private static void HandlePlayerNameChanged(CCS_PlayerNameChangedContext context)
        {
            CCS_NetworkPlayerNameplate nameplate = ResolveNetworkNameplate(context);
        ...
        private static CCS_NetworkPlayerNameplate ResolveNetworkNameplate(CCS_PlayerSessionContext context)
        {
        ...
        private static CCS_NetworkPlayerNameplate ResolveNetworkNameplate(CCS_PlayerNameChangedContext context)
        {
            return context.PlayerRoot != null
                ? context.PlayerRoot.GetComponent<CCS_NetworkPlayerNameplate>()
                : null;
        ...
        private static void ServerTryAnnounceJoin(CCS_NetworkPlayerNameplate nameplate, string playerNameOverride)
        {
            ...
            if (!CCS_NetworkSessionUtility.IsMasterTestSceneActive())
            {
            ...
            string reason)
        {
            ...
            CCS_PlayerSessionEvents.RaiseJoinNotificationQueued(
                new CCS_PlayerJoinNotificationQueuedContext(ownerClientId, sanitizedName, reason));
        }
        ...
        {
            return scene.name == CCS_ValidationUiConstants.MasterTestSceneName
                || scene.path == CCS_ValidationUiConstants.MasterTestScenePath;
        }
