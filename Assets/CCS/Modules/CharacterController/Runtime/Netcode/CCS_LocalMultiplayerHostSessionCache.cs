...
namespace CCS.Modules.CharacterController.Netcode
{
    public static class CCS_LocalMultiplayerHostSessionCache
    {
        ...
        private static readonly string CacheFilePath = Path.Combine(
            Path.GetTempPath(),
            CCS_NetcodeConstants.HostSessionCacheFolderName,
            CCS_NetcodeConstants.HostSessionCacheFileName);
        ...
        private static bool IsHeartbeatFresh(long heartbeatUtcTicks)
        {
            ...
            return ageSeconds <= CCS_NetcodeConstants.HostSessionHeartbeatSeconds;
        }
