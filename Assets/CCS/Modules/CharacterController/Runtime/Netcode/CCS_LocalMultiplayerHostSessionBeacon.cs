...
namespace CCS.Modules.CharacterController.Netcode
{
    public sealed class CCS_LocalMultiplayerHostSessionBeacon : MonoBehaviour
    {
        ...
        private string serverDisplayName = CCS_NetcodeConstants.DefaultServerSessionLabel;
        private string address = CCS_NetcodeConstants.DefaultLocalhostAddress;
        private ushort port = CCS_NetcodeConstants.DefaultServerPort;
        ...
        private void Update()
        {
            ...
            nextHeartbeatTime = Time.unscaledTime + CCS_NetcodeConstants.HostSessionHeartbeatIntervalSeconds;
