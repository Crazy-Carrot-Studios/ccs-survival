...
// SCRIPT: CCS_MultiplayerSpawnUtility
...
// NOTES: Uses dedicated spawn points in SCN_CCS_CharacterController_Validation.
...

{
    ...
    public static class CCS_MultiplayerSpawnUtility

    {
...

        {
            ...
            return activeScene.path == CCS_NetcodeConstants.MasterTestScenePath

                   || activeScene.name == CCS_NetcodeConstants.MasterTestSceneName;
...

        {
            ...
            return GetFallbackSpawnRotation(CCS_NetcodeConstants.MasterTestFallbackSpawnPosition);
