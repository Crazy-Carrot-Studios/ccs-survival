...
// SCRIPT: CCS_LocalMultiplayerLauncher
...
// PLACEMENT: PF_CCS_NetworkManager root.
...

{
    ...
    public sealed class CCS_LocalMultiplayerLauncher : MonoBehaviour

    {
...

        {
            ...
            bool hasCapacity = networkManager.ConnectedClientsIds.Count < CCS_NetcodeConstants.DefaultMaxPlayers;
            ...
            Vector3 spawnPosition = CCS_MultiplayerSpawnUtility.GetSpawnPosition(spawnIndex);
            Quaternion spawnRotation = CCS_MultiplayerSpawnUtility.GetSpawnRotation(spawnIndex);
            ...
            CCS_NetworkSpawnDebugLog.LogConnectionApprovalSpawn(
                ...
                spawnIndex,
                CCS_MultiplayerSpawnUtility.GetSpawnTransformName(spawnIndex),
                spawnPosition,
                spawnRotation);
...

        {
            ...
            if (CCS_MultiplayerSpawnUtility.IsMasterTestSceneActive())
...

        {
            ...
            int spawnIndex = CCS_MultiplayerSpawnUtility.GetSpawnIndexForClient(networkManager, clientId);

            CCS_MultiplayerSpawnUtility.ApplyApprovedSpawnPose(
...

        {
            ...
            CCS_NetworkPlayerController.RefreshAllLocalConfigurations(reason);
...

        {
            ...
            GameObject offlinePlayer = GameObject.Find(CCS_NetcodeConstants.OfflineTestPlayerSceneName);
