...
// =============================================================================
// SCRIPT: CCS_MultiplayerHostingBuildSmoke
...
{
    public sealed class CCS_MultiplayerHostingBuildSmoke : MonoBehaviour
    {
        ...
        public static void BootstrapSmokeTest()
        {
            ...
            GameObject runnerObject = new GameObject(nameof(CCS_MultiplayerHostingBuildSmoke));
            runnerObject.AddComponent<CCS_MultiplayerHostingBuildSmoke>();
        ...
        private IEnumerator Start()
        {
            ...
            while (SceneManager.GetActiveScene().name != CCS_NetcodeConstants.MultiplayerHostingSceneName
            ...
            if (SceneManager.GetActiveScene().name != CCS_NetcodeConstants.MultiplayerHostingSceneName)
            {
                Debug.LogError(
                    $"[Hosting Smoke] Expected scene {CCS_NetcodeConstants.MultiplayerHostingSceneName} "
            ...
            if (!CCS_HostingSceneBuildUtility.IsSceneInBuildSettings(CCS_NetcodeConstants.MasterTestSceneName))
            {
