...
namespace CCS.Modules.CharacterController.Netcode
{
    public static class CCS_MultiplayerServerNameUtility
    {
        ...
        public static string Sanitize(string rawName)
        {
            ...
            {
                return CCS_NetcodeConstants.DefaultServerSessionLabel;
            }

            string trimmed = rawName.Trim();
            if (trimmed.Length > CCS_NetcodeConstants.MaxServerNameLength)
            {
                trimmed = trimmed.Substring(0, CCS_NetcodeConstants.MaxServerNameLength);
            }
        ...
        public static string CreateDefaultServerName(string playerName)
        {
            ...
            if (possessiveName.Length > CCS_NetcodeConstants.MaxServerNameLength)
            {
                return possessiveName.Substring(0, CCS_NetcodeConstants.MaxServerNameLength);
            }
