...
namespace CCS.Modules.CharacterController.Netcode
{
    public sealed class CCS_NetworkPlayerNameplate : NetworkBehaviour
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            CCS_PlayerSessionEvents.RaisePlayerSpawned(CreateSessionContext());
        }
        ...
        private void SubmitDisplayNameServerRpc(string requestedName)
        {
            ...
            CCS_PlayerSessionEvents.RaisePlayerNameChanged(
                new CCS_PlayerNameChangedContext(OwnerClientId, submittedName, gameObject));
        }
        ...
        private CCS_PlayerSessionContext CreateSessionContext()
        {
            return new CCS_PlayerSessionContext(
                OwnerClientId,
                gameObject,
        ...
        private void ResolveReferences()
        {
            ...
            {
                Transform root = transform.Find(CCS_NetcodeConstants.NameplateRootObjectName);
            ...
            {
                Transform textTransform = nameplateRoot.Find(CCS_NetcodeConstants.NameplateTextObjectName);
                if (textTransform == null)
                {
                    textTransform = nameplateRoot.Find(CCS_NetcodeConstants.LegacyNameplateTextObjectName);
                }
        ...
        private void ApplyDisplayName(string value)
        {
            ...
            nameplateText.text = string.IsNullOrWhiteSpace(value)
                ? CCS_NetcodeConstants.DefaultDisplayName
                : value;
        }
