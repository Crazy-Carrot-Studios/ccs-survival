...
| **`0.7.12a`** | **Reticle uses aim target resolver:** reticle consumes `CCS_RevolverAimTargetResolver`; horizon pitch snap mitigated; reveal still Animation Event driven; no body/arm IK, muzzle LOS, or gameplay changes. |
