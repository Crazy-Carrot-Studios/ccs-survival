...
| **`0.7.9`** | **Validation cleanup and aim debug toggle:** prototyping weapon damage target move; legacy TestDetectionCube removal; diagnostics Force Aim Presentation (presentation-only); no gameplay aim/fire changes. |
