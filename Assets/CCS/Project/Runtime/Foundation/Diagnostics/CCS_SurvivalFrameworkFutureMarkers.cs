...
namespace CCS.Project
{
    public static class CCS_SurvivalFrameworkFutureMarkers
    {
        public const string MultiplayerAuthorityIntegration =
            "FUTURE: Multiplayer authority handoff implements CCS_ISurvivalAuthority in gameplay assemblies without netcode references in CCS.Project.Runtime foundation.";
