...
| Building | Structure catalog, placement, inventory costs, and snap foundation (0.8.0–0.8.3) |
| Wildlife | Planned |
| Combat | Planned |
...
**Latest verified build:** 0.8.3
**Build output:** `Builds/CCS_Survival_0.8.3_Windows/` (gitignored)
