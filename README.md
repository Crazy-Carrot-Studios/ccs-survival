...
| Building | Structure definition catalog foundation (0.8.0) |
| Wildlife | Planned |
| Combat | Planned |
...
**Latest verified build:** 0.8.0
**Build output:** `Builds/CCS_Survival_0.8.0_Windows/` (gitignored)
