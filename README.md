...
[![Version](https://img.shields.io/badge/Version-2.0.0-green)](https://github.com/Crazy-Carrot-Studios/ccs-survival/releases)
...
|------|--------|
| Version | **2.0.0** |
| Output | `Builds/CCS_Survival_2.0.0_Windows/` (gitignored) |
...
1. **Single source of truth:** `CCS_SurvivalBootstrapVersionUtility.CurrentMilestoneVersion` (currently **2.0.0**).
