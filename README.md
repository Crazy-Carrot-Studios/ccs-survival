...
| Building | Structure catalog, placement, inventory costs, snap foundation, and persistence restore (0.8.0–0.8.4) |
| Wildlife | Planned |
| Combat | Planned |
...
**Latest verified build:** 0.8.4
**Build output:** `Builds/CCS_Survival_0.8.4_Windows/` (gitignored)
