...
[![Version](https://img.shields.io/badge/Version-1.9.0-green)](https://github.com/Crazy-Carrot-Studios/ccs-survival/releases)
...
|------|--------|
| Version | **1.9.0** |
| Output | `Builds/CCS_Survival_1.9.0_Windows/` (gitignored) |
...
1. **Single source of truth:** `CCS_SurvivalBootstrapVersionUtility.CurrentMilestoneVersion` (currently **1.9.0**).
